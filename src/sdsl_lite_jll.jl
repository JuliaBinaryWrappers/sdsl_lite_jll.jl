...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import sdsl_lite_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("74ccf9ed-edcf-595f-acda-b35b5ec4b965"))
platforms = [Pkg.Artifacts.unpack_platform(e, "sdsl_lite", artifacts_toml) for e in artifacts["sdsl_lite"]]
...
if best_platform === nothing
    @debug("Unable to load sdsl_lite; unsupported platform $(triplet(platform_key_abi()))")
else
