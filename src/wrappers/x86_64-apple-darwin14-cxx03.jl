# Autogenerated wrapper script for sdsl_lite_jll for x86_64-apple-darwin14-cxx03
export libsdsl
...
const libsdsl_splitpath = ["lib", "libsdsl.2.1.0.dylib"]
...
const libsdsl = "@rpath/libsdsl.3.dylib"
